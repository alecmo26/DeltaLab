$(document).ready(function () {
  ...
  $("#btnGetFacts").click(function () {
    ...
    $("#coolNameFactsOutput2").html(nameFact(userName));
    $("#coolNameFactsOutput3").html(secondLetter(userName));
...
function nameFact(name) {
  let fnameLength = name.length; 


  return `and the length of your first name is ` + fnameLength + ` letters long`;
}
function secondLetter(name){
  var nameSecond = name[1];       
  return `also the second letter of your name is ` + nameSecond; 
}
